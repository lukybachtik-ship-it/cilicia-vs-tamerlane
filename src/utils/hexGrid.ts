...
export const SVG_WIDTH = 9 * HEX_WIDTH + 2 * HEX_MARGIN;
export const SVG_HEIGHT = 8 * HEX_V_SPACING + 2 * HEX_SIZE + 2 * HEX_MARGIN;
...
export function getHexNeighbors(pos: Position): Position[] {
